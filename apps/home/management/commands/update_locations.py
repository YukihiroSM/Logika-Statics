...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for idx, row in df.iterrows():
            ...
            if location:
                self.logger.debug(f"Updated location {row['Название локации в ЛМС']}", str(datetime.datetime.now()))
                ...
                self.logger.debug(f"Created location {row['Название локации в ЛМС']}", str(datetime.datetime.now()))
                location = Location(
