...
urlpatterns = [
    ...
    path('add_student_amo_ref/<str:issue_id>', views.create_student_amo_ref_new, name='home'),
    ...
    path('close_issue_reason/<str:issue_id>', views.close_issue_reason_new, name='home'),
    path('close_issue_reason_new/<str:issue_id>', views.close_issue_reason_new, name='home'),
    path('close_no_actions_issue_reason/<str:issue_id>', views.close_no_actions_issue_reason_new, name='home'),
    path('close_no_actions_issue_reason_new/<str:issue_id>', views.close_no_actions_issue_reason_new, name='home'),
    path('resolve_amo_issue/<str:issue_id>', views.resolve_no_amo_issue_without_actions_new, name='home'),
